...
class FollowsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create follow" do
    assert_difference('Follow.count') do
      post follows_url, params: { follow: { following_user_id: @follow.following_user_id, user_id: @follow.user_id } }
    end
  ...
  test "should update follow" do
    patch follow_url(@follow), params: { follow: { following_user_id: @follow.following_user_id, user_id: @follow.user_id } }
